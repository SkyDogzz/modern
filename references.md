...
| 3. Iterators, algorithms, ranges, raw storage | `[iterators]`, `[algorithms]`, `[ranges]`, `[numeric.ops]`, `[memory]` | [iterators](https://en.cppreference.com/w/cpp/iterator), [algorithms](https://en.cppreference.com/w/cpp/algorithm), [ranges](https://en.cppreference.com/w/cpp/ranges), [memory management](https://en.cppreference.com/w/cpp/memory) |
